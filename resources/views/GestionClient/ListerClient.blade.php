     ...
     <div id="wrapper">
         ...
         <div id="content-wrapper" class="d-flex flex-column">
             ...
             <div id="content">
                     ...
                     <?php
                       ...
                       $c = 0;
                        if (!empty($data)) {
                            ...
                            echo '<thead><tr><th>Nom</th><th>Prenom</th><th>Telephone</th><th>Adress</th><th>Email</th><th>Matricule</th><th> Abonnement</th><th> action</th></thead><tbody>';
                            for ($j = 0; $j < count($data); $j++) {
                                ...
                                foreach ($data[$j] as $value) {
                                    ...
                                    if ($c == 6)
                                        echo "<td> Prix : $value ";
                                    if ($c == 7)
                                    echo "<br> Fin : ".substr($value,0,10);
                                    if ($c == 8)
                                    echo "<br> Debut : ".substr($value,0,10)." </td>";
                                    $L=$value;
                                }
                                ?>
                                <td>
                                <form action="{{route('Listerclient.list')}}"  method="get">
                                <input type="hidden" name="ref" value="<?php echo $data[$j]['Email'] ; ?>" > 
                                <button  type="submit" name="submit" onclick="des()" id="desactiver" class="btn btn-sm btn-danger">Desactiver</button>
                                <input type="hidden" name="m" value="<?php echo $data[$j]['Email'] ; ?>" > 
                                <button  type="submit" name="aa" class="btn btn-sm btn-success">Activer</button>
                                </form>
                            </td>
                            </tr>
                            <?php
				 ...
				 <script>
				 document.getElementById("desactiver")..disabled = "true";
