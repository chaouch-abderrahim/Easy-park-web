...
<li class="nav-item dropdown no-arrow">
  ...
  <div class="col-8 " style=" margin:auto;">
    ...
    <form class="row g-3" action="{{route('Modifierabonnement.Update')}}" method="post">
      @csrf
      <div class="col-12">
        <label for="inputEmail4" class="form-label">Matricule</label>
         <select class="form-select" aria-label="Default select example" name="Matricule" required>
                                        <option value=""></option>
                                        <?php
...
if (!empty($data)) {
     for ($j = 0; $j < count($data); $j++) {
        $c = -1;
                ...
                # code...
                echo '<option  > '.$data[$j]['Matricule'].'</option>';
...
?>
      ...
      <div class="col-12">
        ...
        <input type="Time" class="form-control" name="Email" placeholder="Email" required>
      </div>
      <div>
        <div class="col-12">
          <label for="inputAddress2" class="form-label">Message</label>
          <textarea name="Message"  rows="4" cols="86"></textarea>
        </div>
