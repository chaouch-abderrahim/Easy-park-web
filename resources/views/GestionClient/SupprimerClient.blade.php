...
<li class="nav-item dropdown no-arrow">
    ...
    <div class="col-6 " style=" margin:auto;">
        ...
        <form class="row g-3" action="{{route('Deleteclient.delete')}}" method="post">
        @csrf
            <div class="col-12">
                <label for="inputAddress2" class="form-label">Supprimer le client on utilise son matricule</label>
