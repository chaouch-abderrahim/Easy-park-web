        ...
        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#logoutModal">
            ...
            Logout
                ...
                <div class="col-8 " style=" margin:auto;">
                    ...
                    <form class="row g-3" action="{{route('addclient.add')}}" method="post">
                        @csrf
                        <input type="file" name="image" accept="image/*" capture>
                        <div class="col">
                            <label for="inputEmail4" class="form-label">Prénom</label>
                            <input type="text" class="form-control" placeholder="First name" name="firstName" pattern="[a-zA-Z]*\s?[a-zA-Z]*" aria-label="First name" required>
                        </div>
                        <div class="col">
                            <label for="inputEmail4" class="form-label">Nom</label>
                            <input type="text" class="form-control" placeholder="Last name" name="lastName" pattern="[a-zA-Z]*" id="lastName" aria-label="Last name" required>
                        </div>
                        <div>
                            <div class="col-12">
                                <label for="inputAddress2" class="form-label">Telephone</label>
                                <input type="text" class="form-control" id="inputAddress2" placeholder="0123456789" name="telephone" pattern="(\+212|0)[5-7][0-9]{8}$" required>
                            </div>
                            <div class="col-12">
                                <label for="inputAddress2" class="form-label">Matricule</label>
                                <input type="text" class="form-control" id="inputAddress2" placeholder="123-A-456" name="Matricule" pattern="^[1-9][0-9]{0,5}-[a-zA-Z]{1,3}-[1-9][0-9]{0,5}" required>
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                ...
                                <input type="email" class="form-control" id="inputEmail4" placeholder="Email" name="email" required>
                                    ...
                                    <input type="password" class="form-control" id="inputPassword4" pattern="^.{8,}$" title="Au moins 8 caracteres"placeholder=" Mot de passe" name="password" required>
                                </div>
                                <div class="col-12">
                                    <label for="inputPassword4" class="form-label">Confirm Password</label>
                                    <input type="password" class="form-control" id="inputPassword4" placeholder="Utiliser le même mot de passe" name="confirmpassword" required>
                                </div>
                                <div class="col-12">
