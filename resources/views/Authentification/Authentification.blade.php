    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Topbar -->
                <nav style="background-color: rgb(29, 64, 87);" class="navbar navbar-expand  topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div id="admin" class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                ...
                                <a class="dropdown-item" href="#">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" role="switch" onchange="fonction(this)" id="flexSwitchCheckDefault">
                                        <label class="form-check-label" for="flexSwitchCheckDefault">Dark Mode</label>
                                    </div>
                                    <!--Script Dark Mode-->
                                    <script>
                                        function fonction(element) {
                                            var doc = document.getElementById('content-wrapper');
                                            var h1 = document.getElementById('h');
                                            var admin = document.getElementById('admin');
                                            if (element.checked) {
                                                doc.style = "background:black ;";
                                                h1.style = "color:white"
                                                admin.style = "background:black ;";
                ...
                <div class="col-12 " style=" margin:auto;">
                    ...
                    if (!empty($data)) {
                        ...
                        echo '<thead><tr><th>Nom et Prenom</th><th>Telephone</th><th>Email</th><th>Matricule</th><th>Fin d\' Abonnement</th><th> Activer\desactiver</th></thead><tbody>';
                                    ...
                                    if (!empty($data)) {
                                        ...
                                        for ($j = 0; $j < count($data); $j++) {
                                            ...
                                            foreach ($data[$j] as $value) {
                                                ...
                                                if ($c == 4 || $c == 5 )
                                                    echo "<td> " . $value . " </td>";
                                                if($c == 7)echo "<td> " . substr($value,0,10) . " </td>";
                        ...
                        <div class="modal-content">
                            <form>
                                <div class="modal-header">
                                    <h4 class="modal-title">Desactiver Client</h4>
                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                </div>
                                <div class="modal-body">
                                    <p>Are you sure you want to desactiver these clients?</p>
